          ...
          <div>
            ...
            <div className="mb-6 flex flex-wrap gap-4 text-sm text-slate-600">
              ...
              <span className="flex items-center gap-1.5">
                ...
                {bundle.total_cards || flashcards.length} cards
              </span>
            ...
            {bundle.difficulty_level && (
              <div className="mb-6">
                ...
                >
                  {bundle.difficulty_level === 'beginner' && 'Beginner Level'}
                  {bundle.difficulty_level === 'intermediate' && 'Intermediate Level'}
                  {bundle.difficulty_level === 'advanced' && 'Advanced Level'}
                </span>
              </div>
            )}
            ...
            {bundle.description && (
              <div className="mb-6">
                <h3 className="mb-2 font-semibold text-slate-800">About this bundle</h3>
            ...
            {!hasAccess && (
              <div className="rounded-xl border-2 border-french-red-200 bg-french-red-50 p-6">
                <div className="mb-3 flex items-center gap-2 text-french-red-600">
                  ...
                  <h3 className="font-semibold">Limited Preview</h3>
                </div>
                <p className="mb-4 text-sm text-slate-700">
                  You&apos;re viewing {demoCardsCount} of {flashcards.length} flashcards. Unlock
                  all content by purchasing a {bundle.city} City Pass!
                </p>
                <Link
                  href="/pricing"
            ...
            {hasAccess && (
              <div className="rounded-xl border-2 border-green-200 bg-green-50 p-6">
                ...
                <p className="mt-2 text-sm text-slate-700">
                  You have full access to all {flashcards.length} flashcards in this bundle.
                </p>
              </div>
            )}
          </div>
                ...
                <div className="mt-8 rounded-xl bg-slate-100 p-6">
                  <div className="mb-3 flex items-center gap-2 text-slate-700">
                    ...
                    <h4 className="font-semibold">
                      {lockedCardsCount} More Cards Locked
                    </h4>
                  </div>
                  <p className="mb-4 text-sm text-slate-600">
                    Get full access to all flashcards with a {bundle.city} City Pass.
                  </p>
                  <Link
                    href="/pricing"
