      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-parisian-grey-600">
            Időkorlátos hozzáférés az összes prémium tananyaghoz a választott városban.
        ...
        {cities.length > 0 ? (
          ...
          <div className="mx-auto max-w-2xl rounded-xl border-2 border-dashed border-parisian-beige-300 bg-parisian-cream-50 p-12 text-center">
            <Globe className="mx-auto mb-4 h-12 w-12 text-parisian-beige-300" />
            <h3 className="mb-2 font-semibold text-parisian-grey-700">Még nincsenek elérhető városok</h3>
            <p className="text-sm text-parisian-grey-600">
              Hamarosan új városbérletek érkeznek!
            </p>
          </div>
        )}
