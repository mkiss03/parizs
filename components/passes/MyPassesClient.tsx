      ...
      <div className="container mx-auto max-w-5xl px-4">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-slate-600">
            Manage your city access and explore premium content
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          {activePasses.length > 0 ? (
            ...
            <div className="rounded-xl border-2 border-dashed border-slate-300 bg-slate-50 p-12 text-center">
              ...
              <h3 className="mb-2 font-semibold text-slate-600">No Active Passes</h3>
              <p className="mb-6 text-sm text-slate-500">
                Purchase a city pass to unlock premium content
              </p>
              <Link
                href="/pricing"
    ...
    >
      ...
      >
        <div className="mb-2 flex items-center gap-2">
          ...
          <span className="text-sm font-semibold uppercase tracking-wide">City Pass</span>
        </div>
      ...
      <div className="p-6">
        ...
        {isActive ? (
          <div className="mb-6">
            <div className="mb-2 text-sm font-medium text-slate-600">Time Remaining</div>
        ...
        <div className="mb-6 flex items-center justify-between rounded-lg border border-slate-200 p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-slate-700">Included Bundles</span>
          </div>
        ...
        <p className="mt-4 text-center text-xs text-slate-500">
          {isActive ? 'Expires' : 'Expired'} on {expiresAt.toLocaleDateString()} at {expiresAt.toLocaleTimeString()}
        </p>
      </div>
    </div>
  )
