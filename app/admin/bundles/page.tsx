  ...
  const saveMutation = useMutation({
    mutationFn: async ({ id, data }: { id?: string; data: typeof formData }) => {
      ...
      if (id) {
        ...
        const { error } = await supabase
          .from('bundles')
          .insert({ ...data, slug, author_id: userId })
        if (error) throw error
      }
    },
    onSuccess: () => {
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                ...
                <Input
                  ...
                  placeholder="pl. Paris Metro Mastery"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="paris-metro-mastery"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  ...
                  placeholder="Rövid összefoglaló (1-2 mondat)"
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  placeholder="Teljes leírás a csomagról..."
                />
              </div>
            </div>
          </CardContent>
            ...
            >
              ...
              <CardContent className="p-4">
                ...
                <div className="flex items-center gap-2">
                  <Link href={`/admin/bundles/${bundle.id}/cards`}>
                    <Button
                      size="sm"
                      variant="outline"
                      className="flex-1"
