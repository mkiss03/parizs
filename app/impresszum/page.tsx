...
export const metadata = {
  title: 'Impresszum | Szeidl Viktória - Párizsi Idegenvezetés',
  description: 'Jogi információk és kapcsolati adatok - Szeidl Viktória hivatalos idegenvezető Párizsban',
}
